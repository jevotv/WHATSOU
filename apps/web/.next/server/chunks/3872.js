"use strict";exports.id=3872,exports.ids=[3872],exports.modules={43872:(e,r,t)=>{Object.defineProperty(r,"__esModule",{value:!0}),function(e,r){for(var t in r)Object.defineProperty(e,t,{enumerable:!0,get:r[t]})}(r,{resolveRobots:function(){return resolveRobots},resolveSitemap:function(){return resolveSitemap},resolveManifest:function(){return resolveManifest},resolveRouteData:function(){return resolveRouteData}});let o=t(73909);function resolveRobots(e){let r="",t=Array.isArray(e.rules)?e.rules:[e.rules];for(let e of t){let t=(0,o.resolveArray)(e.userAgent||["*"]);for(let e of t)r+=`User-Agent: ${e}
